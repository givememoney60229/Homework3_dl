...
def run(p_seed=0, p_kernel_size=5, p_logdir="temp"):
    ...
    MODEL_FILE = "/home/stevenlin/Desktop/si_sheng/deeplearning_project1/MnistSimpleCNN-master/logs/2/model_epoch_0.pt"
    ...
    np.savetxt("home/stevenlin/Desktop/si_sheng/deeplearning_project1/MnistSimpleCNN-master/logs/%s/wrong%03d.txt"%(p_logdir,p_seed), wrong_images, fmt="%d")
